...
-- neotree config
set("n", "<C-n>", "<cmd>Neotree filesystem toggle<CR>", silent) -- neotree reveal with (ctrl+n)
set("n", "<C-b>", "<cmd>Neotree reveal<CR>", silent) -- reveal current file in neotree
-- set("n", "<C-b>", "<cmd>Neotree reveal=true position=left<CR>y<CR>", silent) -- reveal current file
...
set("n", "<Tab>", "<cmd>BufferLineCycleNext<CR>", silent)
...
-- set("n", "<leader>fg", "<cmd>Telescope live_grep<CR>", silent) -- search words inside files (ctrl+shift+f)
-- set("n", "<leader>fw", "<cmd>Telescope grep_string<CR>", silent) -- search for word under cursor
set("n", "<leader>fm", "<cmd>Telescope marks<CR>", silent) -- search for marks made
set("n", "<leader>:", "<cmd>Telescope command_history<CR>", silent) -- show recent `:` commands
set("n", "<leader>km", "<cmd>Telescope keymaps<CR>", silent) -- all keybindings in a searchable popup
...
set("n", "<leader>tt", "<cmd>FloatermToggle<CR>", { desc = "Toggle Terminal" })
set("n", "<leader>t[", "<cmd>FloatermPrev<CR>", { desc = "Previous Terminal Instance" })
set("n", "<leader>t]", "<cmd>FloatermNext<CR>", { desc = "Next Terminal Instance" })
