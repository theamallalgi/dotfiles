# Amal's Dotfiles and Configurations (For Arch/Linux)
...
> [!WARNING]
> This repository and its contents are technically a Work in Progress, review the code before copying anything.
> Hyprland configuration was migrated to Lua (v5.5) at commit [6ca2b91](https://github.com/theamallalgi/dotfiles/commit/6ca2b91). The old pre-Lua config files are available [here](https://github.com/theamallalgi/dotfiles/tree/main/.config/hypr/v5.4).
...
- Web - [Heliummm!!!!](https://helium.computer/) (I hate [Firefox](https://media.tenor.com/znx_AntI870AAAAM/gorilla-middle-finger.gif) with a passion)
- Shell - [Zsh](https://en.wikipedia.org/wiki/Z_shell) & [Nushell](https://www.nushell.sh/) (obv bash too..)
